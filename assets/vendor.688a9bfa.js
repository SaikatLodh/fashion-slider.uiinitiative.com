...
var ae = (i, e, t) => e in i ? be(i, e, {
    ...
    W = (i, e) => {
        ...
        if (ne)
            for (var t of ne(e)) Me.call(e, t) && ae(i, t, e[t]);
        return i
    },
    j = (i, e) => ye(i, Ee(e));
    ...
    for (let S = 0; S < u; S += 1) {
        ...
        if (c[S] && (y = c[S]), V && i.grid.updateSlide(S, y, c), !(c[S] && D(y, "display") === "none")) {
            if (t.slidesPerView === "auto") {
                ...
                if (b && (y.style.transform = "none"), C && (y.style.webkitTransform = "none"), t.roundLengths) I = i.isHorizontal() ? fe(y, "width", !0) : fe(y, "height", !0);
                else {
                    const L = e(E, "width"),
                        k = e(E, "padding-left"),
...
function Ue() {
    ...
    else l ? (a = e.filter(u => u.column === n)[0], c = e.filter(u => u.column === n + 1)[0], d = e.filter(u => u.column === n - 1)[0]) : a = e[n];
    ...
    Z = i => {
        ...
        if (i.params.rewind || i.params.loop)
            for (let l = n - e; l <= r + e; l += 1) {
                ...
                for (let l = Math.max(n - e, 0); l <= Math.min(r + e, t - 1); l += 1) l !== n && (l > r || l < n) && Q(i, l)
    };
...
function Qe(i) {
    ...
    if (typeof a == "undefined" && (a = Je(e)), s.indexOf(t) >= 0) d = s.indexOf(t);
    else {
...
function nt(i, e, t, s, n) {
    ...
    if (s && i > a ? c = a : s && i < d ? c = d : c = i, r.updateProgress(c), l.cssMode) {
        ...
        if (e === 0) o[u ? "scrollLeft" : "scrollTop"] = -c;
            ...
            if (!r.support.smoothScroll) return de({
                swiper: r,
                targetPosition: -c,
                side: u ? "left" : "top"
            }), !0;
...
const ge = (i, e) => {
    ...
    t[a]("touchstart", i.onDocumentTouchStart, {
        ...
        passive: !0
    }), (s.preventClicks || s.preventClicksPropagation) && n[a]("click", i.onClick, !0), s.cssMode && r[a]("scroll", i.onScroll), s.updateOnWindowResize ? i[d](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", he, !0) : i[d]("observerUpdate", he, !0), n[a]("load", i.onLoad, {
        capture: !0
    })
};
...
class G {
    constructor() {
        ...
        const o = this;
        o.__swiper__ = !0, o.support = ue(), o.device = Be({
    ...
    getSlideIndex(e) {
        const {
            slidesEl: t,
            params: s
        } = this, n = O(t, `.${s.slideClass}, swiper-slide`), r = ce(n[0]);
        return ce(e) - r
    }
    ...
    slidesPerViewDynamic(e, t) {
        ...
        if (n.centeredSlides) {
            ...
            for (let u = d + 1; u < r.length; u += 1)(t ? l[u] + o[u] - l[d] < a : l[u] - l[d] < a) && (c += 1);
        else
            for (let u = d - 1; u >= 0; u -= 1) l[d] - l[u] < a && (c += 1);
        return c
    }
    update() {
        const e = this;
...
function Xt(i) {
    ...
    const n = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
        r = (a, d) => {
            const {
                rtl: c
            } = e, u = c ? -1 : 1, p = a.getAttribute("data-swiper-parallax") || "0";
